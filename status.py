#!/usr/bin/env python3
"""
LeadGen Pro - Status Script v3.0
=================================
...
def main():
    ...
    if not runners:
        ...
        for r in runners:
            ...
            if stats:
                print(f"      Posts: {stats.get('posts_checked', 0)} | Replies: {stats.get('replies_sent', 0)} | Leads: {stats.get('leads_found', 0)}")
