...
def start_background():
    ...
    runners = ["telegram", "reddit", "twitter", "discord", "facebook", "instagram", "tiktok"]
...
def main():
    parser = argparse.ArgumentParser(description="LeadGen Pro Starter v3.0")
